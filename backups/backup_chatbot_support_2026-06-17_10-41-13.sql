...
INSERT INTO `chat_messages` VALUES (1,1,'как подключить api','Для подключения API используйте POST-запрос на /api/v1/endpoint. Не забудьте заголовок Authorization: Bearer ваш_токен.','2026-06-08 15:10:39'),(2,1,'как подключить api','Для подключения API используйте POST-запрос на /api/v1/endpoint. Не забудьте заголовок Authorization: Bearer ваш_токен.','2026-06-09 12:18:03'),(3,1,'пароль','Используйте форму восстановления пароля. Если не приходит письмо - проверьте спам или обратитесь в поддержку.','2026-06-09 13:49:12'),(4,1,'500','Ошибка 500 часто из-за синтаксиса PHP или прав на файлы. Посмотрите логи error_log().','2026-06-09 16:24:57'),(5,1,'500','Ошибка 500 часто из-за синтаксиса PHP или прав на файлы. Посмотрите логи error_log().','2026-06-09 16:27:01'),(6,1,'ошибка sql','Проверьте синтаксис, имена таблиц и кавычки. Включите отладку: error_reporting(E_ALL); mysqli_report(MYSQLI_REPORT_ERROR);','2026-06-09 17:12:02'),(7,1,'как подключить api','Для подключения API используйте POST-запрос на /api/v1/endpoint. Не забудьте заголовок Authorization: Bearer ваш_токен.','2026-06-09 17:12:04'),(8,1,'сбросить пароль','Используйте форму восстановления пароля. Если не приходит письмо - проверьте спам или обратитесь в поддержку.','2026-06-09 17:12:19'),(9,1,'как сбросить пароль','Используйте форму восстановления пароля. Если не приходит письмо - проверьте спам или обратитесь в поддержку.','2026-06-09 17:13:41'),(10,1,'привет','Привет! Чем могу помочь по PHP, SQL или API?','2026-06-09 17:15:00'),(11,1,'сбросить пароль','Используйте форму восстановления пароля. Если не приходит письмо - проверьте спам или обратитесь в поддержку.','2026-06-09 17:15:28'),(12,1,'php валидация','Используйте filter_var($email, FILTER_VALIDATE_EMAIL) и preg_match для телефона. Обязательно htmlspecialchars() для защиты от XSS.','2026-06-09 17:15:36'),(13,1,'как подключить api','Для подключения API используйте POST-запрос на /api/v1/endpoint. Не забудьте заголовок Authorization: Bearer ваш_токен.','2026-06-09 19:24:38'),(14,1,'Как удалить аккаунт?','Напишите в поддержку через форму обратной связи с темой «Удаление аккаунта»','2026-06-09 19:27:12'),(15,1,'Как скачать дистрибутив Linux через установщик?','Нажмите «Смотреть» на карточке дистрибутива, затем выберите «Скачать через установщик»','2026-06-09 19:27:14'),(16,1,'ошибка 500','Ошибка 500 часто из-за синтаксиса PHP или прав на файлы. Посмотрите логи error_log().','2026-06-09 19:27:20'),(17,1,'как подключить api','Для подключения API используйте POST-запрос на /api/v1/endpoint. Не забудьте заголовок Authorization: Bearer ваш_токен.','2026-06-09 19:27:28'),(18,1,'привет','Привет! Чем могу помочь по PHP, SQL или API?','2026-06-09 19:30:37'),(19,4,'Как удалить аккаунт?','Напишите в поддержку через форму обратной связи с темой «Удаление аккаунта»','2026-06-09 19:36:44'),(20,1,'?','Извините, я не смог распознать ваш запрос. Вот что я умею: удалить аккаунт, подписка,оформить,оплата, флешка,не видит флешку, скачать дистрибутив,linux,установщик, не могу войти,войти,аккаунт. Пожалуйста, переформулируйте вопрос.','2026-06-11 10:29:53'),(21,7,'Как удалить аккаунт?','Напишите в поддержку через форму обратной связи с темой «Удаление аккаунта»','2026-06-17 07:30:12'),(22,7,'аккаунт','Проверьте правильность ввода email и пароля. Используйте кнопку «Забыли пароль?»','2026-06-17 07:30:16'),(23,7,'скачать','Извините, я не смог распознать ваш запрос. Вот что я умею: удалить аккаунт, подписка,оформить,оплата, флешка,не видит флешку, скачать дистрибутив,linux,установщик, не могу войти,войти,аккаунт. Пожалуйста, переформулируйте вопрос.','2026-06-17 07:30:24'),(24,7,'linux','Нажмите «Смотреть» на карточке дистрибутива, затем выберите «Скачать через установщик»','2026-06-17 07:30:36'),(25,7,'Как удалить аккаунт?','Напишите в поддержку через форму обратной связи с темой «Удаление аккаунта»','2026-06-17 07:38:21'),(26,7,'Установщик не видит мою флешку','Нажмите «Смотреть» на карточке дистрибутива, затем выберите «Скачать через установщик»','2026-06-17 07:38:23'),(27,7,'флешка','Проверьте подключение, перезапустите установщик от имени администратора','2026-06-17 07:38:27'),(28,7,'дистрибутив','Извините, я не смог распознать ваш запрос. Вот что я умею: удалить аккаунт, подписка,оформить,оплата, флешка,не видит флешку, скачать дистрибутив,linux,установщик, не могу войти,войти,аккаунт. Пожалуйста, переформулируйте вопрос.','2026-06-17 07:38:35'),(29,7,'linux','Нажмите «Смотреть» на карточке дистрибутива, затем выберите «Скачать через установщик»','2026-06-17 07:38:40'),(30,7,'сбросить пароль','Используйте форму восстановления пароля. Если не приходит письмо - проверьте спам или обратитесь в поддержку.','2026-06-17 07:38:47'),(31,7,'Как удалить аккаунт?','Напишите в поддержку через форму обратной связи с темой «Удаление аккаунта»','2026-06-17 07:40:04'),(32,7,'Как оформить подписку?','Подписка оформляется в личном кабинете после регистрации','2026-06-17 07:40:06'),(33,7,'Как скачать дистрибутив Linux через установщик?','Нажмите «Смотреть» на карточке дистрибутива, затем выберите «Скачать через установщик»','2026-06-17 07:40:07'),(34,7,'Установщик не видит мою флешку','Нажмите «Смотреть» на карточке дистрибутива, затем выберите «Скачать через установщик»','2026-06-17 07:40:07'),(35,7,'linux','Нажмите «Смотреть» на карточке дистрибутива, затем выберите «Скачать через установщик»','2026-06-17 07:40:10'),(36,7,'?','Извините, я не смог распознать ваш запрос. Вот что я умею: удалить аккаунт, подписка,оформить,оплата, флешка,не видит флешку, скачать дистрибутив,linux,установщик, не могу войти,войти,аккаунт. Пожалуйста, переформулируйте вопрос.','2026-06-17 07:40:16'),(37,7,'сбросить пароль','Используйте форму восстановления пароля. Если не приходит письмо - проверьте спам или обратитесь в поддержку.','2026-06-17 07:40:19'),(38,1,'Как оформить подписку?','Подписка оформляется в личном кабинете после регистрации','2026-06-17 07:40:48');
...
-- Dump completed on 2026-06-17 10:41:13
